...
ls -lrS ~/DATA/C/pics/cards/ | head -2500 | cut -c 53- | sed 's/.full.jpg$//' | sed 's/\s/%20/g' | awk '{print "<br><div style=\"height: 20px; \"><a href=https://magiccards.info/query?q=" $1 "&v=cards&s=cname target=_blank ><span style=\"font-size:32px; \">" $1 "</span></a></div>"}' > /home/masayume/DATA/C/pics/cards-new-faster/0-magic2download.htm
