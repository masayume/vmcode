...
document.addEventListener("DOMContentLoaded", function () {
    (document.getElementById("pixlInput").onchange = function (t) {
        ...
        document.getElementById("addcustomcolor").addEventListener("click", function () {
            var e = document.getElementById("customcolor").value,
                t = document.createElement("span");
            (t.style.backgroundColor = e), (t.dataset.color = rgbToInt(e).join(",")), t.classList.add("colorblock"), document.getElementById("currentpallete").appendChild(t);
        }),
        document.getElementById("savecustompalette").addEventListener("click", function () {
            var e = [];
            document.querySelectorAll("#currentpallete .colorblock").forEach(function (t) {
                e.push(t.dataset.color);
            }),
                (e = removeDuplicates(e).map(function (e) {
                    return e.split(",");
                })),
                addPalette(e);
            for (var t = document.getElementById("currentpallete"); t.firstChild; ) t.removeChild(t.firstChild);
        }),
        document.getElementById("clearcustompalettes").addEventListener("click", function () {
