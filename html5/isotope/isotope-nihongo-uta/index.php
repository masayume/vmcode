...
<head>
  <meta charset="UTF-8">
  <title>masayume's nihongo no uta</title>
...
<body>
  <div id="pagetitle" style="float: left;">
    masayume's nihongo no uta
  </div>  


<div id="filters" class="button-group" style="float: right;">  <button class="button is-checked" data-filter="*">show all</button>
  <button class="button" data-filter=".arcade">arcade</button>
  <button class="button" data-filter=".alkali, .alkaline-earth">alkali...</button>
  <button class="button" data-filter=":not(.transition)">not tr..</button>
  <button class="button" data-filter=".metal:not(.transition)">metal ..</button>
  <button class="button" data-filter="numberGreaterThan50">num > 50</button>
