document.addEventListener('DOMContentLoaded', function () {
  ...
  function generateElementsOrig(amount) {
  ...
  function generateElements(amount) {
    ...
    var tools = ["AudioTool","Blender","contextfree","fotosketcher","LDD","leocad","live2d_euclid","magicavoxel","mandelbulb3d"];

      ret.push(generateElement(++uuid, "AudioTool",'green',2,2));
      ret.push(generateElement(++uuid, "Blender",'blue',2,2));
      ret.push(generateElement(++uuid, "contextfree",'red',2,2));
      ret.push(generateElement(++uuid, "fotosketcher",'cyan',2,2));
      ret.push(generateElement(++uuid, "LDD",'blue',2,2));
      ret.push(generateElement(++uuid, "leocad",'blue',2,2));
      ret.push(generateElement(++uuid, "live2d_euclid",'cyan',2,2));
      ret.push(generateElement(++uuid, "magicavoxel",'blue',2,2));
      ret.push(generateElement(++uuid, "mandelbulb3d",'blue',2,2));
  ...
  function generateElement(id, title, color, width, height) {
    ...
    var backgroundName = 'img/pin-' + title + '.png';
    var itemTemplate = '' +
        '<div class="' + classNames + '" data-id="' + id + '" data-color="' + color + '" data-title="' + title + '">' +
          '<div class="item-content">' +
            '<div class="card">' +
              '<img src="' + backgroundName + '" width="200px" />' + 
